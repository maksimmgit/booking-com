...
public class RegistrationForm {
    ...
    //edit title
    private final SelenideElement EDIT_TITLE = $x("//body/div[@id='root']/div[contains(@class,'my-settings-outer-container')]/div[@class='my-settings-app-container']/div[@class='my-settings-main-container']/div[@class='my-settings-flex-by-row']/div[@class='my-settings-flex-grow']/div[@class='my-settings-page']/div[contains(@class,'my-settings-edit-table bui-f-font-featured')]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/button[1]/span[1]");
    //choose
    ...
    //Save DisplayName
    private final SelenideElement SAVE_DISPLAY_NAME = $x("//button[@data-ga-label='Save section: nickname']/span[@class=\"bui-button__text\"]");
    //check green tick
    private final SelenideElement CHECK_GREEN_TICK1 = $x("//form[@class='my-settings-edit-row-form']//span[@role='presentation']//*[name()='svg']");
    private final SelenideElement CHECK_GREEN_TICK = $x("//*[name()='svg'][@role='img'])[17]");
    ...
    private final SelenideElement DISPLAY_NAME_CHECK = $x("//div[@class='my-settings-display-mode']/div[contains(text(), \"DisplayName1AAc\")]");
    private final SelenideElement EMAIL_CHECK = $x("//div[@class='my-settings-no-wrap']/div[contains(text(), \"testqa100101@yandex.ru\")]");
    private final SelenideElement DOB_CHECK = $x("//div[contains(text(),'24/12/1940')]");
    ...
    public boolean inputCorrectPassword(String s) {
        ...
        NEW_PASSWORD_FORM.setValue(s).pressTab().click();
        NEW_PASSWORD_CONFIRMATION.setValue(s).pressTab().click();
        ...
        //Здесь попытка поймать всплывающий фрейм после робота, но решил просто выставить таймер 15 секунд, помогло.
/*        SelenideElement roboButton = $x("//*[contains(text(), 'Нажать и удерживать')]").shouldBe(visible);
        Selenide.actions().moveToElement(roboButton).clickAndHold().pause(Duration.ofSeconds(5)).release().perform();*/
    ...
    public void editPersonalDetails(String displayName, String DD, String MM, String YYYY){
        ...
        Selenide.actions()
                ...
                .clickAndHold(SAVE_DISPLAY_NAME)
